...
from models import db, Note, BorrowedBook
...
def confirmed_returned(note_id):
    ...
    db.session.commit()
    return f"{borrowed_note.title} sucessfully returned! Deposit money will be returned to buyer. By default book / note is set to hidden, You can update to available if you want to lend again<a href='/dashboard'>Return to dashboard</a>"